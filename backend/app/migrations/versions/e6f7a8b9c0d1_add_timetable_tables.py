...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("short_break_minutes", sa.SmallInteger(), nullable=False, server_default="10"),
        sa.Column("long_break_minutes", sa.SmallInteger(), nullable=False, server_default="25"),
