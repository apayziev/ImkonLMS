...
import { countDayInRange } from "@/lib/dates"
                      ...
                      return (
                        ...
                        >
                          {entry ? (
                            ...
                            >
                              <div
                                className={`absolute left-0 top-0 bottom-0 w-[3px] rounded-l-lg ${isCompleted ? "bg-[#00A27D]" : isInProgress ? "bg-amber-400" : "bg-primary"}`}
                              />
                              {isThisLoading ? (
